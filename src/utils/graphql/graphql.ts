...
export const AddCustomerDocument = `
    mutation addCustomer($firstName: String!, $lastName: String!, $countryCode: String!, $phone: Int!, $promotions: Boolean!, $email: String!) {
  addCustomer(
    firstName: $firstName
    lastName: $lastName
...
export const AddEmployeeDocument = `
    mutation addEmployee($firstName: String!, $lastName: String!, $branch: ID!, $countryCode: String!, $phone: Int!, $employeeId: String!, $email: String!) {
  addEmployee(
    firstName: $firstName
    lastName: $lastName
    countryCode: $countryCode
