...
import { fetchData } from "@survey/utils/graphql/fetcher";
...
export type BranchDataFragment = {
  __typename?: "Branch";
  id?: string | null;
  name?: string | null;
  location?: string | null;
...
export type CompanyDataFragment = {
  ...
  createdAt?: string | null;
  updatedAt?: string | null;
  branches?: Array<{ __typename?: "Branch"; id?: string | null } | null> | null;
};
...
export const BranchDocument = `
  ...
  branch(id: $id) {
    ...
    ${BranchDataFragmentDoc}`;
export const useBranchQuery = <TData = BranchQuery, TError = unknown>(
...
export const AddBranchDocument = `
  ...
  addBranch(name: $name, location: $location, company: $company, urlId: $urlId) {
    ...
    ${BranchDataFragmentDoc}`;
export const useAddBranchMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddBranchMutation,
    TError,
    AddBranchMutationVariables,
    TContext
  >
) =>
  useMutation<AddBranchMutation, TError, AddBranchMutationVariables, TContext>(
    ["addBranch"],
    (variables?: AddBranchMutationVariables) =>
      fetchData<AddBranchMutation, AddBranchMutationVariables>(
        AddBranchDocument,
        variables
      )(),
    options
...
export const useAddCompanyMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: AddCompanyMutationVariables) =>
      fetchData<AddCompanyMutation, AddCompanyMutationVariables>(
        AddCompanyDocument,
        variables
      )(),
    options
...
export const useCustomersQuery = <TData = CustomersQuery, TError = unknown>(
  ...
  useQuery<CustomersQuery, TError, TData>(
    ["Customers", variables],
    fetchData<CustomersQuery, CustomersQueryVariables>(
      CustomersDocument,
      variables
    ),
    options
...
export const useAddCustomerMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: AddCustomerMutationVariables) =>
      fetchData<AddCustomerMutation, AddCustomerMutationVariables>(
        AddCustomerDocument,
        variables
      )(),
    options
...
export const AddEmployeeDocument = `
  ...
  addEmployee(
    ...
    ${EmployeeDataFragmentDoc}`;
export const useAddEmployeeMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddEmployeeMutation,
    TError,
  ...
  >(
    ["addEmployee"],
    (variables?: AddEmployeeMutationVariables) =>
      fetchData<AddEmployeeMutation, AddEmployeeMutationVariables>(
        AddEmployeeDocument,
        variables
      )(),
    options
...
export const ReviewDocument = `
  ...
  review(id: $id) {
    ...
    ${ReviewDataFragmentDoc}`;
export const useReviewQuery = <TData = ReviewQuery, TError = unknown>(
...
export const AddReviewDocument = `
  ...
  addReview(
    ...
    ${ReviewDataFragmentDoc}`;
export const useAddReviewMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddReviewMutation,
    TError,
  ...
  useMutation<AddReviewMutation, TError, AddReviewMutationVariables, TContext>(
    ["addReview"],
    (variables?: AddReviewMutationVariables) =>
      fetchData<AddReviewMutation, AddReviewMutationVariables>(
        AddReviewDocument,
        variables
      )(),
    options
...
export const UrlsDocument = `
  ...
  urls(recordsToGet: $recordsToGet) {
    ...
    ${UrlDataFragmentDoc}`;
export const useUrlsQuery = <TData = UrlsQuery, TError = unknown>(
...
export const UrlDocument = `
  ...
  url(id: $id) {
    ...
    ${UrlDataFragmentDoc}`;
export const useUrlQuery = <TData = UrlQuery, TError = unknown>(
...
export const UrlIdDocument = `
  ...
  urlRecord(urlId: $urlId, test: $test) {
    ...
    ${UrlDataFragmentDoc}`;
export const useUrlIdQuery = <TData = UrlIdQuery, TError = unknown>(
...
export const AddUrlDocument = `
  ...
  addUrl(urlId: $urlId, originalUrl: $originalUrl) {
    ...
    ${UrlDataFragmentDoc}`;
export const useAddUrlMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddUrlMutation,
    TError,
  ...
  useMutation<AddUrlMutation, TError, AddUrlMutationVariables, TContext>(
    ["addUrl"],
    (variables?: AddUrlMutationVariables) =>
      fetchData<AddUrlMutation, AddUrlMutationVariables>(
        AddUrlDocument,
        variables
      )(),
    options
